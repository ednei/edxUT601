...
#define MAX_INTERSECTION_STATES 1+GRR;

#define TRANSACTION_DELAY_SECS 2
...
const IntersectionStateInfo IntersectionMachine[7]={
// West								      South									   Walk									 Time				 		 	      [000  001  010  011  100  101  110  111] <= Possible inputs:[walk,south,west]
	...
	{STREET_SEMAPHORO_RED		 ,STREET_SEMAPHORO_RED		,WALK_SEMAPHORO_RED		,TRANSACTION_DELAY_SECS,{RRR, RRG, RGR, RGR, GRR, GRR, GRR, GRR}}, //State RRR P1
	{STREET_SEMAPHORO_GREEN  ,STREET_SEMAPHORO_RED		,WALK_SEMAPHORO_RED		,TRANSACTION_DELAY_SECS,{RRG, RRG, RRY, RRY, RRY, RRY, RRY, RRY}}, //State RRG P2
	{STREET_SEMAPHORO_YELLOW ,STREET_SEMAPHORO_RED		,WALK_SEMAPHORO_RED		,TRANSACTION_DELAY_SECS,{RRR, RRR, RGR, RGR, GRR, GRR, GRR, GRR}}, //State RRY
	{STREET_SEMAPHORO_RED    ,STREET_SEMAPHORO_GREEN	,WALK_SEMAPHORO_RED		,TRANSACTION_DELAY_SECS,{RGR, RYR, RGR, RGR, RYR, RYR, RYR, RYR}}, //State RGR
	{STREET_SEMAPHORO_RED    ,STREET_SEMAPHORO_YELLOW	,WALK_SEMAPHORO_RED		,TRANSACTION_DELAY_SECS,{RRR, RRG, RRR, RRR, GRR, GRR, GRR, GRR}}, //State RYR	
	{STREET_SEMAPHORO_RED    ,STREET_SEMAPHORO_RED		,WALK_SEMAPHORO_GREEN	,TRANSACTION_DELAY_SECS,{GRR, RRG, RGR, RGR, GRR, GRR, GRR, GRR}} //State GRR
};
